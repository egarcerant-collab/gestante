...
const availableFiles = {
  "2026": {
    ...
    "JULIO": "/BASES/2026/JULIO/julio.xlsx",
  },
};
...
export default function KpiPage() {
  ...
  const prepararDatosParaPdf = (kpiData: KpiResults, ips: string, recomendacionesAI?: string[], analisisAnual?: string, firmante?: { nombre: string; cargo: string; firma?: string }, dept?: string, muni?: string): InformeDatos => {
    ...
    return {
        ...
        datosAExtraer: [
            { label: "── Indicadores de Captación ──", valor: "" },
            ...
            { label: "── Indicadores de Tamizaje VIH ──", valor: "" },
            ...
            { label: "── Indicadores de Tamizaje Sífilis ──", valor: "" },
            ...
            { label: "── Indicadores de Tamizaje Toxoplasma ──", valor: "" },
            ...
            { label: "── Indicadores de Tamizaje Hepatitis B ──", valor: "" },
            ...
            { label: "── Indicadores de Tamizaje Chagas ──", valor: "" },
            ...
            { label: "── Indicadores de Ecografías ──", valor: "" },
            ...
            { label: "── Indicadores de Nutrición ──", valor: "" },
            ...
            { label: "── Indicadores de Odontología ──", valor: "" },
            ...
            { label: "── Indicadores de Ginecología (Alto Riesgo) ──", valor: "" },
            ...
            { label: "── Indicadores de Último Control Prenatal ──", valor: "" },
